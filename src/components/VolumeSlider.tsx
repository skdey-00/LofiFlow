...
export function VolumeSlider({ soundId, emoji, x, y, engine, onClose, onOpenEQ }: VolumeSliderProps) {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        zIndex: 9999, // High z-index to appear above all icons
      }}
    >
      <div style={{
        ...
        <motion.button
          ...
          style={{
            ...
            padding: "10px",
            borderRadius: "8px",
            background: "linear-gradient(135deg, rgba(236, 72, 153, 0.2) 0%, rgba(233, 196, 106, 0.2) 100%)",
